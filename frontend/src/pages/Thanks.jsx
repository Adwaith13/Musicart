  ...
  return (
    <div>
      ...
      <div className={thankStyles.container}>
        ...
        <p  className={thankStyles.text}>You will be receiving a confirmation email with order details</p>
        <button  className={thankStyles.btn} onClick={()=>navigate("/")}>Go back to Home page</button>
      </div>
      <Footer />
    </div>
  );
